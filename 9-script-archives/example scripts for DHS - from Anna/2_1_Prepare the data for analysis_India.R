...
IDs <- c("IA2015DHS_IA_maharashtra", "IA2020DHS_IA_maharashtra")
IDs
...
for (a in IDs) {
  ...
  for (y in year){
    ...
    rd0 <- brick(paste("D:/Anna/Dropbox/Data/NOAA/tmax/tmax.",y,".nc", sep="")) 
    #plot(rd0,1)
  ...
  for (y in year){
    ...
    rd0 <- brick(paste("D:/Anna/Dropbox/Data/NOAA/tmin/tmin.",y,".nc", sep="")) 
    #plot(rd0,1)
    rd1 <- rotate(rd0) #convert the LONG from 0:360 to -180:180 degree 
    #plot(rd1, 1)
    ...
    df4 <- df3 %>% 
      dplyr::select(-c(ID)) %>% 
      gather(key = date, value = tmin, -SurveyId, -clust) %>%
      mutate(date = as.Date(substring(date, 2), format = "%Y.%m.%d"),
             year  = format(date, format = "%Y"),
             month = format(date, format = "%m"),
             day   =  format(date, format = "%d"))
  ...
  temp <- tmax %>% 
    ...
    dplyr::select(SurveyId, clust, date, year, month, day, tmax, tmin, tmean)
  ...
  write.csv(pct_thresholds_tmean, paste("./pct_thresholds/",a,"_pct_thresholds_tmean.csv", sep=""))
  write.csv(pct_thresholds_tmax, paste("./pct_thresholds/",a,"_pct_thresholds_tmax.csv", sep=""))
  ...
  temp <- temp %>% 
    ...
    mutate(Tmax_20_25    = ifelse(tmax >=20 & tmax <25, 1, 0)) %>% 
    mutate(Tmax_25_30    = ifelse(tmax >=25 & tmax <30, 1, 0)) %>% 
    mutate(Tmax_30_35    = ifelse(tmax >=30 & tmax <35, 1, 0)) %>% 
    mutate(Tmax_above_35 = ifelse(tmax >=35, 1, 0)) %>% 
    ## Tmean absolute bins
    ...
    mutate(Tmean_20_25    = ifelse(tmean >=20 & tmean <25, 1, 0)) %>% 
    mutate(Tmean_25_30    = ifelse(tmean >=25 & tmean <30, 1, 0)) %>% 
    mutate(Tmean_30_35    = ifelse(tmean >=30 & tmean <35, 1, 0)) %>% 
    mutate(Tmean_above_35 = ifelse(tmean >=35, 1, 0)) %>% 
  ...
  tbins <- temp %>% 
    ...
    dplyr::summarise(
      ...
      Tmax_20_25 = sum(Tmax_20_25),
      Tmax_25_30 = sum(Tmax_25_30),
      Tmax_30_35 = sum(Tmax_30_35),
      Tmax_above_35 = sum(Tmax_above_35),
      ## Tmean
      Tmean_below_5 = sum(Tmean_below_5),
      Tmean_5_10  = sum(Tmean_5_10),
      Tmean_10_15 = sum(Tmean_10_15),
      Tmean_15_20 = sum(Tmean_15_20),
      Tmean_20_25 = sum(Tmean_20_25),
      Tmean_25_30 = sum(Tmean_25_30),
      Tmean_30_35 = sum(Tmean_30_35),
      Tmean_above_35 = sum(Tmean_above_35),
  ...
  df5 <- df5 %>%  
    ...
    dplyr::rename(Tmax_below_5_lag0 = Tmax_below_5,   
                  ...
                  Tmax_20_25_lag0 = Tmax_20_25,
                  Tmax_25_30_lag0 = Tmax_25_30,
                  Tmax_30_35_lag0 = Tmax_30_35,
                  Tmax_above_35_lag0 = Tmax_above_35,
                  ## Absolute Tmean
                  Tmean_below_5_lag0 = Tmean_below_5,
                  Tmean_5_10_lag0 = Tmean_5_10, 
                  Tmean_10_15_lag0 = Tmean_10_15,
                  Tmean_15_20_lag0 = Tmean_15_20,
                  Tmean_20_25_lag0 = Tmean_20_25,
                  Tmean_25_30_lag0 = Tmean_25_30,
                  Tmean_30_35_lag0 = Tmean_30_35,
                  Tmean_above_35_lag0 = Tmean_above_35,
                  tmax_lag0 = tmax,
                  tmean_lag0 = tmean,
                  ## Tmax prc
    ...
    dplyr::rename(Tmax_below_5_lag1 = Tmax_below_5,  
                  ...
                  Tmax_20_25_lag1 = Tmax_20_25,
                  Tmax_25_30_lag1 = Tmax_25_30,
                  Tmax_30_35_lag1 = Tmax_30_35,
                  Tmax_above_35_lag1 = Tmax_above_35,
                  ## Absolute Tmean
                  Tmean_below_5_lag1 = Tmean_below_5,  
                  Tmean_5_10_lag1 = Tmean_5_10, 
                  Tmean_10_15_lag1 = Tmean_10_15,
                  Tmean_15_20_lag1 = Tmean_15_20,
                  Tmean_20_25_lag1 = Tmean_20_25,
                  Tmean_25_30_lag1 = Tmean_25_30,
                  Tmean_30_35_lag1 = Tmean_30_35,
                  Tmean_above_35_lag1 = Tmean_above_35,
                  tmax_lag1 = tmax,
                  tmean_lag1 = tmean,
                  ## Tmax prc
    ...
    dplyr::rename(Tmax_below_5_lag2 = Tmax_below_5,  
                  ...
                  Tmax_20_25_lag2 = Tmax_20_25,
                  Tmax_25_30_lag2 = Tmax_25_30,
                  Tmax_30_35_lag2 = Tmax_30_35,
                  Tmax_above_35_lag2 = Tmax_above_35,
                  ## Absolute Tmean
                  Tmean_below_5_lag2 = Tmean_below_5,  
                  Tmean_5_10_lag2 = Tmean_5_10, 
                  Tmean_10_15_lag2 = Tmean_10_15,
                  Tmean_15_20_lag2 = Tmean_15_20,
                  Tmean_20_25_lag2 = Tmean_20_25,
                  Tmean_25_30_lag2 = Tmean_25_30,
                  Tmean_30_35_lag2 = Tmean_30_35,
                  Tmean_above_35_lag2 = Tmean_above_35,
                  tmax_lag2 = tmax,
                  tmean_lag2 = tmean,
                  ## Tmax prc
    ...
    dplyr::rename(Tmax_below_5_lag3 = Tmax_below_5,  
                  ...
                  Tmax_20_25_lag3 = Tmax_20_25,
                  Tmax_25_30_lag3 = Tmax_25_30,
                  Tmax_30_35_lag3 = Tmax_30_35,
                  Tmax_above_35_lag3 = Tmax_above_35,
                  ## Absolute Tmean
                  Tmean_below_5_lag3 = Tmean_below_5,  
                  Tmean_5_10_lag3 = Tmean_5_10, 
                  Tmean_10_15_lag3 = Tmean_10_15,
                  Tmean_15_20_lag3 = Tmean_15_20,
                  Tmean_20_25_lag3 = Tmean_20_25,
                  Tmean_25_30_lag3 = Tmean_25_30,
                  Tmean_30_35_lag3 = Tmean_30_35,
                  Tmean_above_35_lag3 = Tmean_above_35,
                  tmax_lag3 = tmax,
                  tmean_lag3 = tmean,
                  ## Tmax prc
    ...
    dplyr::rename(Tmax_below_5_lag4 = Tmax_below_5,  
                  ...
                  Tmax_20_25_lag4 = Tmax_20_25,
                  Tmax_25_30_lag4 = Tmax_25_30,
                  Tmax_30_35_lag4 = Tmax_30_35,
                  Tmax_above_35_lag4 = Tmax_above_35,
                  ## Absolute Tmean
                  Tmean_below_5_lag4 = Tmean_below_5,  
                  Tmean_5_10_lag4 = Tmean_5_10, 
                  Tmean_10_15_lag4 = Tmean_10_15,
                  Tmean_15_20_lag4 = Tmean_15_20,
                  Tmean_20_25_lag4 = Tmean_20_25,
                  Tmean_25_30_lag4 = Tmean_25_30,
                  Tmean_30_35_lag4 = Tmean_30_35,
                  Tmean_above_35_lag4 = Tmean_above_35,
                  tmax_lag4 = tmax,
                  tmean_lag4 = tmean,
                  ## Tmax prc
    ...
    dplyr::rename(Tmax_below_5_lag5 = Tmax_below_5,  
                  ...
                  Tmax_20_25_lag5 = Tmax_20_25,
                  Tmax_25_30_lag5 = Tmax_25_30,
                  Tmax_30_35_lag5 = Tmax_30_35,
                  Tmax_above_35_lag5 = Tmax_above_35,
                  ## Absolute Tmean
                  Tmean_below_5_lag5 = Tmean_below_5,  
                  Tmean_5_10_lag5 = Tmean_5_10, 
                  Tmean_10_15_lag5 = Tmean_10_15,
                  Tmean_15_20_lag5 = Tmean_15_20,
                  Tmean_20_25_lag5 = Tmean_20_25,
                  Tmean_25_30_lag5 = Tmean_25_30,
                  Tmean_30_35_lag5 = Tmean_30_35,
                  Tmean_above_35_lag5 = Tmean_above_35,
                  tmax_lag5 = tmax,
                  tmean_lag5 = tmean,
                  ## Tmax prc
    ...
    dplyr::rename(Tmax_below_5_lag6 = Tmax_below_5,  
                  ...
                  Tmax_20_25_lag6 = Tmax_20_25,
                  Tmax_25_30_lag6 = Tmax_25_30,
                  Tmax_30_35_lag6 = Tmax_30_35,
                  Tmax_above_35_lag6 = Tmax_above_35,
                  ## Absolute Tmean
                  Tmean_below_5_lag6 = Tmean_below_5,  
                  Tmean_5_10_lag6 = Tmean_5_10, 
                  Tmean_10_15_lag6 = Tmean_10_15,
                  Tmean_15_20_lag6 = Tmean_15_20,
                  Tmean_20_25_lag6 = Tmean_20_25,
                  Tmean_25_30_lag6 = Tmean_25_30,
                  Tmean_30_35_lag6 = Tmean_30_35,
                  Tmean_above_35_lag6 = Tmean_above_35,
                  tmax_lag6 = tmax,
                  tmean_lag6 = tmean,
                  ## Tmax prc
    ...
    dplyr::rename(Tmax_below_5_lag7 = Tmax_below_5,  
                  ...
                  Tmax_20_25_lag7 = Tmax_20_25,
                  Tmax_25_30_lag7 = Tmax_25_30,
                  Tmax_30_35_lag7 = Tmax_30_35,
                  Tmax_above_35_lag7 = Tmax_above_35,
                  ## Absolute Tmean
                  Tmean_below_5_lag7 = Tmean_below_5,  
                  Tmean_5_10_lag7 = Tmean_5_10, 
                  Tmean_10_15_lag7 = Tmean_10_15,
                  Tmean_15_20_lag7 = Tmean_15_20,
                  Tmean_20_25_lag7 = Tmean_20_25,
                  Tmean_25_30_lag7 = Tmean_25_30,
                  Tmean_30_35_lag7 = Tmean_30_35,
                  Tmean_above_35_lag7 = Tmean_above_35,
                  tmax_lag7 = tmax,
                  tmean_lag7 = tmean,
                  ## Tmax prc
    ...
    dplyr::rename(Tmax_below_5_lag8 = Tmax_below_5,  
                  ...
                  Tmax_20_25_lag8 = Tmax_20_25,
                  Tmax_25_30_lag8 = Tmax_25_30,
                  Tmax_30_35_lag8 = Tmax_30_35,
                  Tmax_above_35_lag8 = Tmax_above_35,
                  ## Absolute Tmean
                  Tmean_below_5_lag8 = Tmean_below_5,  
                  Tmean_5_10_lag8 = Tmean_5_10, 
                  Tmean_10_15_lag8 = Tmean_10_15,
                  Tmean_15_20_lag8 = Tmean_15_20,
                  Tmean_20_25_lag8 = Tmean_20_25,
                  Tmean_25_30_lag8 = Tmean_25_30,
                  Tmean_30_35_lag8 = Tmean_30_35,
                  Tmean_above_35_lag8 = Tmean_above_35,
                  tmax_lag8 = tmax,
                  tmean_lag8 = tmean,
                  ## Tmax prc
    ...
    dplyr::rename(Tmax_below_5_lag9 = Tmax_below_5,  
                  ...
                  Tmax_20_25_lag9 = Tmax_20_25,
                  Tmax_25_30_lag9 = Tmax_25_30,
                  Tmax_30_35_lag9 = Tmax_30_35,
                  Tmax_above_35_lag9 = Tmax_above_35,
                  ## Absolute Tmean
                  Tmean_below_5_lag9 = Tmean_below_5,  
                  Tmean_5_10_lag9 = Tmean_5_10, 
                  Tmean_10_15_lag9 = Tmean_10_15,
                  Tmean_15_20_lag9 = Tmean_15_20,
                  Tmean_20_25_lag9 = Tmean_20_25,
                  Tmean_25_30_lag9 = Tmean_25_30,
                  Tmean_30_35_lag9 = Tmean_30_35,
                  Tmean_above_35_lag9 = Tmean_above_35,
                  tmax_lag9 = tmax,
                  tmean_lag9 = tmean,
                  ## Tmax prc
    ...
    dplyr::rename(Tmax_below_5_lag10 = Tmax_below_5,  
                  ...
                  Tmax_20_25_lag10 = Tmax_20_25,
                  Tmax_25_30_lag10 = Tmax_25_30,
                  Tmax_30_35_lag10 = Tmax_30_35,
                  Tmax_above_35_lag10 = Tmax_above_35,
                  ## Absolute Tmean
                  Tmean_below_5_lag10 = Tmean_below_5,  
                  Tmean_5_10_lag10 = Tmean_5_10, 
                  Tmean_10_15_lag10 = Tmean_10_15,
                  Tmean_15_20_lag10 = Tmean_15_20,
                  Tmean_20_25_lag10 = Tmean_20_25,
                  Tmean_25_30_lag10 = Tmean_25_30,
                  Tmean_30_35_lag10 = Tmean_30_35,
                  Tmean_above_35_lag10 = Tmean_above_35,
                  tmax_lag10 = tmax,
                  tmean_lag10 = tmean,
                  ## Tmax prc
    ...
    dplyr::rename(Tmax_below_5_lag11 = Tmax_below_5,  
                  ...
                  Tmax_20_25_lag11 = Tmax_20_25,
                  Tmax_25_30_lag11 = Tmax_25_30,
                  Tmax_30_35_lag11 = Tmax_30_35,
                  Tmax_above_35_lag11 = Tmax_above_35,
                  ## Absolute Tmean
                  Tmean_below_5_lag11 = Tmean_below_5,  
                  Tmean_5_10_lag11 = Tmean_5_10, 
                  Tmean_10_15_lag11 = Tmean_10_15,
                  Tmean_15_20_lag11 = Tmean_15_20,
                  Tmean_20_25_lag11 = Tmean_20_25,
                  Tmean_25_30_lag11 = Tmean_25_30,
                  Tmean_30_35_lag11 = Tmean_30_35,
                  Tmean_above_35_lag11 = Tmean_above_35,
                  tmax_lag11 = tmax,
                  tmean_lag11 = tmean,
                  ## Tmax prc
    ...
    dplyr::rename(Tmax_below_5_lag12 = Tmax_below_5,  
                  ...
                  Tmax_20_25_lag12 = Tmax_20_25,
                  Tmax_25_30_lag12 = Tmax_25_30,
                  Tmax_30_35_lag12 = Tmax_30_35,
                  Tmax_above_35_lag12 = Tmax_above_35,
                  ## Absolute Tmean
                  Tmean_below_5_lag12 = Tmean_below_5,  
                  Tmean_5_10_lag12 = Tmean_5_10, 
                  Tmean_10_15_lag12 = Tmean_10_15,
                  Tmean_15_20_lag12 = Tmean_15_20,
                  Tmean_20_25_lag12 = Tmean_20_25,
                  Tmean_25_30_lag12 = Tmean_25_30,
                  Tmean_30_35_lag12 = Tmean_30_35,
                  Tmean_above_35_lag12 = Tmean_above_35,
                  tmax_lag12 = tmax,
                  tmean_lag12 = tmean,
                  ## Tmax prc
    ...
    dplyr::rename(Tmax_below_5_lag13 = Tmax_below_5,  
                  ...
                  Tmax_20_25_lag13 = Tmax_20_25,
                  Tmax_25_30_lag13 = Tmax_25_30,
                  Tmax_30_35_lag13 = Tmax_30_35,
                  Tmax_above_35_lag13 = Tmax_above_35,
                  ## Absolute Tmean
                  Tmean_below_5_lag13 = Tmean_below_5,  
                  Tmean_5_10_lag13 = Tmean_5_10, 
                  Tmean_10_15_lag13 = Tmean_10_15,
                  Tmean_15_20_lag13 = Tmean_15_20,
                  Tmean_20_25_lag13 = Tmean_20_25,
                  Tmean_25_30_lag13 = Tmean_25_30,
                  Tmean_30_35_lag13 = Tmean_30_35,
                  Tmean_above_35_lag13 = Tmean_above_35,
                  tmax_lag13 = tmax,
                  tmean_lag13 = tmean,
                  ## Tmax prc
    ...
    dplyr::rename(Tmax_below_5_lag14 = Tmax_below_5,  
                  ...
                  Tmax_20_25_lag14 = Tmax_20_25,
                  Tmax_25_30_lag14 = Tmax_25_30,
                  Tmax_30_35_lag14 = Tmax_30_35,
                  Tmax_above_35_lag14 = Tmax_above_35,
                  ## Absolute Tmean
                  Tmean_below_5_lag14 = Tmean_below_5,  
                  Tmean_5_10_lag14 = Tmean_5_10, 
                  Tmean_10_15_lag14 = Tmean_10_15,
                  Tmean_15_20_lag14 = Tmean_15_20,
                  Tmean_20_25_lag14 = Tmean_20_25,
                  Tmean_25_30_lag14 = Tmean_25_30,
                  Tmean_30_35_lag14 = Tmean_30_35,
                  Tmean_above_35_lag14 = Tmean_above_35,
                  tmax_lag14 = tmax,
                  tmean_lag14 = tmean,
                  ## Tmax prc
    ...
    dplyr::rename(Tmax_below_5_lag15 = Tmax_below_5,  
                  ...
                  Tmax_20_25_lag15 = Tmax_20_25,
                  Tmax_25_30_lag15 = Tmax_25_30,
                  Tmax_30_35_lag15 = Tmax_30_35,
                  Tmax_above_35_lag15 = Tmax_above_35,
                  ## Absolute Tmean
                  Tmean_below_5_lag15 = Tmean_below_5,  
                  Tmean_5_10_lag15 = Tmean_5_10, 
                  Tmean_10_15_lag15 = Tmean_10_15,
                  Tmean_15_20_lag15 = Tmean_15_20,
                  Tmean_20_25_lag15 = Tmean_20_25,
                  Tmean_25_30_lag15 = Tmean_25_30,
                  Tmean_30_35_lag15 = Tmean_30_35,
                  Tmean_above_35_lag15 = Tmean_above_35,
                  tmax_lag15 = tmax,
                  tmean_lag15 = tmean,
                  ## Tmax prc
  ...
  df5 <- df5 %>% 
    ...
    # TMAX 20 to 25
    mutate(Tmax_20_25_trim1 = Tmax_20_25_lag6 + Tmax_20_25_lag7 + Tmax_20_25_lag8,
           Tmax_20_25_trim2 = Tmax_20_25_lag3 + Tmax_20_25_lag4 + Tmax_20_25_lag5,
           Tmax_20_25_trim3 = Tmax_20_25_lag0 + Tmax_20_25_lag1 + Tmax_20_25_lag2,
           Tmax_20_25_trim_minus1 = Tmax_20_25_lag9 + Tmax_20_25_lag10 + Tmax_20_25_lag11,
           Tmax_20_25_trim_minus2 = Tmax_20_25_lag12 + Tmax_20_25_lag13 + Tmax_20_25_lag14
    ) %>% 
    # TMAX 25 to 30
    mutate(Tmax_25_30_trim1 = Tmax_25_30_lag6 + Tmax_25_30_lag7 + Tmax_25_30_lag8,
           Tmax_25_30_trim2 = Tmax_25_30_lag3 + Tmax_25_30_lag4 + Tmax_25_30_lag5,
           Tmax_25_30_trim3 = Tmax_25_30_lag0 + Tmax_25_30_lag1 + Tmax_25_30_lag2,
           Tmax_25_30_trim_minus1 = Tmax_25_30_lag9 + Tmax_25_30_lag10 + Tmax_25_30_lag11,
           Tmax_25_30_trim_minus2 = Tmax_25_30_lag12 + Tmax_25_30_lag13 + Tmax_25_30_lag14
    ) %>% 
    # TMAX 30 to 35
    mutate(Tmax_30_35_trim1 = Tmax_30_35_lag6 + Tmax_30_35_lag7 + Tmax_30_35_lag8,
           Tmax_30_35_trim2 = Tmax_30_35_lag3 + Tmax_30_35_lag4 + Tmax_30_35_lag5,
           Tmax_30_35_trim3 = Tmax_30_35_lag0 + Tmax_30_35_lag1+ Tmax_30_35_lag2,
           Tmax_30_35_trim_minus1 = Tmax_30_35_lag9 + Tmax_30_35_lag10 + Tmax_30_35_lag11,
           Tmax_30_35_trim_minus2 = Tmax_30_35_lag12 + Tmax_30_35_lag13 + Tmax_30_35_lag14
    ) %>% 
    # TMAX above 35
    mutate(Tmax_above_35_trim1 = Tmax_above_35_lag6 + Tmax_above_35_lag7 + Tmax_above_35_lag8,
           Tmax_above_35_trim2 = Tmax_above_35_lag3 + Tmax_above_35_lag4 + Tmax_above_35_lag5,
           Tmax_above_35_trim3 = Tmax_above_35_lag0 + Tmax_above_35_lag1 + Tmax_above_35_lag2,
           Tmax_above_35_trim_minus1 = Tmax_above_35_lag9 + Tmax_above_35_lag10 + Tmax_above_35_lag11,
           Tmax_above_35_trim_minus2 = Tmax_above_35_lag12 + Tmax_above_35_lag13 + Tmax_above_35_lag14
    ) 
  ...
  df5 <- df5 %>% 
    ...
    # Tmean 20 to 25
    mutate(Tmean_20_25_trim1 = Tmean_20_25_lag6 + Tmean_20_25_lag7 + Tmean_20_25_lag8,
           Tmean_20_25_trim2 = Tmean_20_25_lag3 + Tmean_20_25_lag4 + Tmean_20_25_lag5,
           Tmean_20_25_trim3 = Tmean_20_25_lag0 + Tmean_20_25_lag1 + Tmean_20_25_lag2,
           Tmean_20_25_trim_minus1 = Tmean_20_25_lag9 + Tmean_20_25_lag10 + Tmean_20_25_lag11,
           Tmean_20_25_trim_minus2 = Tmean_20_25_lag12 + Tmean_20_25_lag13 + Tmean_20_25_lag14
    ) %>% 
    # Tmean 25 to 30
    mutate(Tmean_25_30_trim1 = Tmean_25_30_lag6 + Tmean_25_30_lag7 + Tmean_25_30_lag8,
           Tmean_25_30_trim2 = Tmean_25_30_lag3 + Tmean_25_30_lag4 + Tmean_25_30_lag5,
           Tmean_25_30_trim3 = Tmean_25_30_lag0 + Tmean_25_30_lag1 + Tmean_25_30_lag2,
           Tmean_25_30_trim_minus1 = Tmean_25_30_lag9 + Tmean_25_30_lag10 + Tmean_25_30_lag11,
           Tmean_25_30_trim_minus2 = Tmean_25_30_lag12 + Tmean_25_30_lag13+ Tmean_25_30_lag14
    ) %>% 
    # Tmean 30 to 35
    mutate(Tmean_30_35_trim1 = Tmean_30_35_lag6 + Tmean_30_35_lag7 + Tmean_30_35_lag8,
           Tmean_30_35_trim2 = Tmean_30_35_lag3 + Tmean_30_35_lag4 + Tmean_30_35_lag5,
           Tmean_30_35_trim3 = Tmean_30_35_lag0 + Tmean_30_35_lag1 + Tmean_30_35_lag2,
           Tmean_30_35_trim_minus1 = Tmean_30_35_lag9 + Tmean_30_35_lag10 + Tmean_30_35_lag11,
           Tmean_30_35_trim_minus2 = Tmean_30_35_lag12 + Tmean_30_35_lag13 + Tmean_30_35_lag14
    ) %>% 
    # Tmean above 35
    mutate(Tmean_above_35_trim1 = Tmean_above_35_lag6 + Tmean_above_35_lag7 + Tmean_above_35_lag8,
           Tmean_above_35_trim2 = Tmean_above_35_lag3 + Tmean_above_35_lag4 + Tmean_above_35_lag5,
           Tmean_above_35_trim3 = Tmean_above_35_lag0 + Tmean_above_35_lag1 + Tmean_above_35_lag2,
           Tmean_above_35_trim_minus1 = Tmean_above_35_lag9 + Tmean_above_35_lag10 + Tmean_above_35_lag11,
           Tmean_above_35_trim_minus2 = Tmean_above_35_lag12 + Tmean_above_35_lag13 + Tmean_above_35_lag14
    ) 
  ...
  write.csv(df5, paste("./data_for_analysis_India/", a, ".csv", sep=""))  
}
