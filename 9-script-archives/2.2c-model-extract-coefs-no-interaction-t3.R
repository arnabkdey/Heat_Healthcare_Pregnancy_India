...
model_outputs <- readRDS(here(path_processed, "2.1c-models-no-interaction-comp-t3.rds"))
...
saveWorkbook(wb, here(path_out, "models_full_comp_t3.xlsx"), overwrite = TRUE)
...
write.csv(combined_exposures, here(path_out, "models_consolidated_coefficients_comp_t3.csv"), row.names = FALSE)
