...
model_outputs <- readRDS(here(path_processed, "2.1b-models-no-interaction-comp-t2.rds"))
...
saveWorkbook(wb, here(path_out, "models_full_comp_t2.xlsx"), overwrite = TRUE)
...
write.csv(combined_exposures, here(path_out, "models_consolidated_coefficients_comp_t2.csv"), row.names = FALSE)
