...
/// Percentile
//// Trimester-1
poisson dv_comp_excessive_bi iv_pc_t1_bin1 iv_pc_t1_bin2 iv_pc_t1_bin4 iv_pc_t1_bin5 ///
        i.ses_caste_tri_num i.ses_religion_tri_num i.ses_wealth_bi_num i.ses_residence_num ses_fertAge_std ///
        i.season_birth_num#i.region_num, vce(robust) irr
		
outreg2 using excessive_pc_t1.xls, replace excel dec(3) eform sideway stat(coef ci) level(95) ///
    keep(iv_pc_t1_bin1 iv_pc_t1_bin2 iv_pc_t1_bin4 iv_pc_t1_bin5) 
	
//// Trimester-2
poisson dv_comp_excessive_bi iv_pc_t2_bin1 iv_pc_t2_bin2 iv_pc_t2_bin4 iv_pc_t2_bin5 ///
        i.ses_caste_tri_num i.ses_religion_tri_num i.ses_wealth_bi_num i.ses_residence_num ses_fertAge_std ///
        i.season_birth_num#i.region_num, vce(robust) irr

outreg2 using excessive_pc_t2.xls, replace excel dec(3) eform sideway stat(coef ci) level(95) ///
    keep(iv_pc_t2_bin1 iv_pc_t2_bin2 iv_pc_t2_bin4 iv_pc_t2_bin5) 
	
//// Trimester-3
poisson dv_comp_excessive_bi iv_pc_t3_bin1 iv_pc_t3_bin2 iv_pc_t3_bin4 iv_pc_t3_bin5 ///
        i.ses_caste_tri_num i.ses_religion_tri_num i.ses_wealth_bi_num i.ses_residence_num ses_fertAge_std ///
        i.season_birth_num#i.region_num, vce(robust) irr

outreg2 using excessive_pc_t3.xls, replace excel dec(3) eform sideway stat(coef ci) level(95) ///
    keep(iv_pc_t3_bin1 iv_pc_t3_bin2 iv_pc_t3_bin4 iv_pc_t3_bin5) 


////// Absolute 
//// Trimester-1
poisson dv_comp_excessive_bi iv_abs_t1_bin1 iv_abs_t1_bin2 iv_abs_t1_bin4 iv_abs_t1_bin5 ///
        i.ses_caste_tri_num i.ses_religion_tri_num i.ses_wealth_bi_num i.ses_residence_num ses_fertAge_std ///
        i.season_birth_num#i.region_num, vce(robust) irr
...
//// Trimester-2
poisson dv_comp_excessive_bi iv_abs_t2_bin1 iv_abs_t2_bin2 iv_abs_t2_bin4 iv_abs_t2_bin5 ///
        i.ses_caste_tri_num i.ses_religion_tri_num i.ses_wealth_bi_num i.ses_residence_num ses_fertAge_std ///
        i.season_birth_num#i.region_num, vce(robust) irr
...
outreg2 using excessive_abs_t3.xls, replace excel dec(3) eform sideway stat(coef ci) level(95) ///
