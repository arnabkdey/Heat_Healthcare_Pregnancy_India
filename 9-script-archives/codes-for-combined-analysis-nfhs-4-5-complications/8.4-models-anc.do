// Read dataset
use "Z:\Shared drives\Benmarhnia Lab\Arnab\project-datasets\manuscripts\heat-and-complications-India\processed-data\7.4-dhs-5-IR-merged-processed.dta"
...
/// Percentile
mepoisson dv_no_four_anc_bi iv_pc_full_bin1 iv_pc_full_bin2 iv_pc_full_bin4 iv_pc_full_bin5 ///
        i.ses_caste_tri_num i.ses_religion_tri_num i.ses_wealth_bi_num i.ses_residence_num i.ses_edu_num ses_fertAge_std i.ses_edu_num ///
...
/// Absolute
mepoisson dv_no_four_anc_bi iv_abs_full_bin1 iv_abs_full_bin2 iv_abs_full_bin4 iv_abs_full_bin5 ///
        i.ses_caste_tri_num i.ses_religion_tri_num i.ses_wealth_bi_num i.ses_residence_num i.ses_edu_num ses_fertAge_std i.ses_edu_num ///
        i.season_birth_num || psu_num:, vce(robust) irr

outreg2 using anc_abs_full.xls, replace excel dec(3) eform sideway stat(coef ci) level(95) ///
