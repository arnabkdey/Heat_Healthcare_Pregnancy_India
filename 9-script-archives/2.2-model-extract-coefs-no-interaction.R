...
model_outputs <- readRDS(here(path_processed, "2.1-models-no-interaction-comp-age.rds"))
...
write.csv(combined_exposures, here(path_out, "models_consolidated_coefficients_comp_age.csv"), row.names = FALSE)
