...
dir.create(here(path_outputs, "models", "full_models", "sensitivity_district_re"), recursive = TRUE, showWarnings = FALSE)
path_outputs_models_root <- here(path_outputs, "models", "full_models", "sensitivity_district_re")
...
# saveRDS(all_weighted_data, here(path_outputs, "models", "full_models", "iptw_weights", 
