...
dir.create(here(path_outputs, "models", "full_models", "sensitivity_6mo"), recursive = TRUE, showWarnings = FALSE)
path_outputs_models_root <- here(path_outputs, "models", "full_models", "sensitivity_6mo")
...
# Load prepared data ----
all_data <- readRDS(here(path_processed, "1.3.3_cumulative_bins_all_datasets_6mo.rds"))
